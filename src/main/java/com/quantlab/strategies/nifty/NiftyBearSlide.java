...
/**
 * <b>NiftyBearSlide</b> &mdash; Bear Put Spread.
 *
 * <p>Leg structure:
 * <ul>
 *   <li>Buy 1 ATM PE</li>
 *   <li>Sell 1 OTM PE at ATM &minus; 3 &times; strikeInterval (ATM&minus;150)</li>
 * </ul>
 *
 * <p>A net-debit strategy that profits from a moderate downside move. The sold
 * OTM put finances part of the ATM purchase, capping both profit and loss.
 *
 * <p>Max profit = strike width &minus; net debit. Max loss = net debit paid.
 *
 * <p>Entry: moderately bearish outlook, IV neutral to high (selling expensive
 * OTM premium).
 *
 * <p>Exit conditions:
 * <ol>
 ...
 * @author QuantLab
 */
public class NiftyBearSlide extends BaseStrategy {

    private static final String STRATEGY_NAME = "NiftyBearSlide";
    ...
    private static final int BEAR_SPREAD_WIDTH = 3;
    ...
    /**
     * Constructs a new NiftyBearSlide strategy.
     *
     * @param orderService       broker-agnostic order service
     * @param marketDataProvider broker-agnostic market data provider
     */
    public NiftyBearSlide(OrderService orderService, MarketDataProvider marketDataProvider) {
        super(buildConfig());
     ...
     * {@inheritDoc}
     *
     * <p>Buys 1 ATM PE and sells 1 OTM PE (ATM&minus;150) to construct the
     * bear put spread.
     */
    @Override
    public void onEntry() {
        ...
        int otmStrike = atmStrike - BEAR_SPREAD_WIDTH * STRIKE_INTERVAL;
     ...
     * {@inheritDoc}
     *
     * <p>Squares off all open legs of the bear put spread.
     */
    @Override
    public void onExit() {
        if (!positionOpen) {
